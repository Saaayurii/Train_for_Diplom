            ...
            <div className="content-grid">
              <div className="content-card">
                ...
                <p>
                  ...
                  железнодорожной инфраструктуры, от планирования маршрутов до мониторинга подвижного состава.
                </p>
              </div>
              <div className="content-card">
                <div className="card-icon">📊</div>
                ...
                <p>
                  Мощные инструменты анализа данных позволяют оптимизировать работу железнодорожного транспорта,
                  сокращать затраты и повышать эффективность перевозок.
                </p>
              </div>
              <div className="content-card">
                <div className="card-icon">🔒</div>
                ...
                <p>
                  Система обеспечивает высокий уровень безопасности данных и непрерывность работы благодаря
                  современным технологиям защиты информации.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="features-list">
              <div className="feature-item">
                ...
                <div className="feature-content">
                  ...
                  <p>
                    Полный контроль над железнодорожной инфраструктурой: пути, станции, депо, сигнализация.
                    Визуализация в режиме реального времени на интерактивной карте.
                  </p>
                </div>
              </div>
              <div className="feature-item">
                ...
                <div className="feature-content">
                  ...
                  <p>
                    Интеллектуальная система построения оптимальных маршрутов с учетом загруженности путей,
                    расписания и технических характеристик подвижного состава.
                  </p>
                </div>
              </div>
              <div className="feature-item">
                ...
                <div className="feature-content">
                  ...
                  <p>
                    Отслеживание состояния и местоположения поездов в реальном времени. Управление парком
                    подвижного состава и планирование технического обслуживания.
                  </p>
                </div>
              </div>
              <div className="feature-item">
                ...
                <div className="feature-content">
                  ...
                  <p>
                    Проведение комплексных исследований для оптимизации работы железной дороги. Моделирование
                    различных сценариев и анализ эффективности решений.
                  </p>
                </div>
              </div>
            </div>
