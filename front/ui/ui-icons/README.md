...
<a href="https://osrd.fr">Железная дорога</a> components & <a href="https://design.osrd.fr">design system</a>.
...
2. in osrd-ui/ui-icons: launch `npm run svgo` to optimize svg size.
